...
<li>New strings have been released for the application itself and also for the documentation related to the new release, so they can already be translated via Weblate</li>\
</ul>\
